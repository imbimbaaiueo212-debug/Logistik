...
@section('title', 'Packing - biMBA Logistik')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        ...
        <a href="{{ route('packing.jakarta.aktif') }}" class="group">
            <div class="bg-white rounded-3xl shadow p-8 hover:shadow-xl transition-all h-full">
                ...
                <p class="text-gray-500 text-sm">Packing Jakarta Aktif</p>
            </div>
        </a>
        ...
        <a href="{{ route('packing.jakarta-pasif') }}" class="group">
            <div class="bg-white rounded-3xl shadow p-8 hover:shadow-xl transition-all h-full">
                ...
                <p class="text-gray-500 text-sm">Packing Jakarta Pasif</p>
            </div>
        </a>
        ...
        <a href="#" class="group">
            <div class="bg-white rounded-3xl shadow p-8 hover:shadow-xl transition-all h-full">
                ...
                <p class="text-gray-500 text-sm">Packing DLC</p>
            </div>
        </a>
        ...
        <a href="#" class="group">
            <div class="bg-white rounded-3xl shadow p-8 hover:shadow-xl transition-all h-full">
                ...
                <p class="text-gray-500 text-sm">Packing EBT</p>
            </div>
        </a>

        {{-- ===== ORDER MANUAL ===== --}}
        <a href="{{ route('packing.order-manual') }}" class="group">
            <div class="bg-white rounded-3xl shadow p-8 hover:shadow-xl transition-all h-full border-2 border-transparent group-hover:border-blue-500">
                ...
                <p class="text-gray-500 text-sm">Packing dari Order Manual</p>
            </div>
        </a>
