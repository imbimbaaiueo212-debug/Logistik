...
@section('title', 'Jakarta Aktif - biMBA AIUEO Logistik')
            ...
            <div class="flex items-center justify-between gap-4 flex-wrap mb-4">
                <div class="action-bar">
                    <div class="action-buttons">
                        ...
                        {{-- KANAN: REKAP --}}
                        <div>
                            <a href="{{ route('order.jakarta-printed') }}" class="btn-rekap">
                        ...
                        {{-- EXPORT --}}
                        <a href="{{ route('order.jakarta-aktif.export') }}{{ $queryString ? '?' . $queryString : '' }}" class="btn-action btn-export">
                ...
                <tr class="{{ $isLocked ? 'processed-row' : '' }} {{ $isRefund ? 'bg-red-50' : '' }}">
                    ...
                    <td class="px-4 py-3 text-center">
                        ...
                        @else
                            ...
                            title="Edit">
                                <svg class="w-4 h-4 inline" viewBox="0 0 20 20" fill="currentColor"><path d="M13.586 3.586a2 2 0 1 1 2.828 2.828l-.793.793-2.828-2.828.793-.793ZM11.379 5.793 3 14.172V17h2.828l8.38-8.379-2.83-2.828Z"/></svg>
                            </a>
                        @endif
                    </td>
                </tr>
