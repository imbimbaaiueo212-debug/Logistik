...
<head>
    ...
    <style>
        ...
        .col-no       { width: 32px; }
        .col-id       { width: 78px; }
        .col-unit     { width: 155px; }
        .col-kategori { width: 115px; }
        .col-bayar    { width: 85px; }
        .col-estimasi { width: 88px; }
        .col-pic      { width: 95px; }
        .col-catatan  { width: 160px; }
        ...
        /* ===== PENTING: REPEAT HEADER DI SETIAP HALAMAN BARU ===== */
        thead {
    ...
    <table>
        <thead>
            ...
            <tr class="header1">
                ...
                <th rowspan="2" class="col-bayar header-cell">WAKTU BAYAR</th>
                <th rowspan="2" class="col-estimasi header-cell">ESTIMASI (WAKTU)</th>
                <th rowspan="2" class="col-pic header-cell">PIC</th>
