...
<head>
    ...
    <title>Pesanan Majalah Kotamadya - biMBA AIUEO Logistik</title>
...
<div class="max-w-screen-2xl mx-auto px-6 py-6">
    ...
    <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">
                Daftar periode pesanan majalah Kotamadya. Klik judul untuk melihat detail data Kotamadya & unit.
            </p>
        </div>
    ...
    {{-- TABEL (HANYA LEVEL JUDUL / PERIODE) --}}
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center py-20 text-gray-500">
                            ...
                            <p class="text-sm mt-1">Belum ada periode pesanan majalah Kotamadya.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
...
<div id="importModal" class="hidden fixed inset-0 z-50 bg-black/50 flex items-center justify-center px-4">
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg" onclick="event.stopPropagation()">
        ...
        <div class="flex justify-between items-center px-6 py-5 border-b">
            <div>
                <h2 class="text-xl font-bold text-gray-800">Import Pesanan Majalah Kotamadya</h2>
                <p class="text-sm text-gray-500 mt-1">Pilih periode tujuan import data.</p>
            </div>
            <button type="button" onclick="closeImportModal()"
                class="text-gray-500 hover:text-red-600 text-2xl font-bold">&times;</button>
        </div>

        <form id="formImportMajalahKotamadya"
            action="{{ route('pesanan-majalah-kotamadya.import') }}"
            method="POST"
            ...
            <div class="mb-5">
                ...
                <p class="text-xs text-gray-500 mt-2">
                    Pilih bulan dan tahun untuk data yang akan diimport.
                </p>
            </div>
...
function saveNoPs(input) {
    ...
    // Kirim ke server
    fetch(`/pesanan-majalah-kotamadya/${id}/update-no-ps`, {
        method: 'POST',
        headers: {
