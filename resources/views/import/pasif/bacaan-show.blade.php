...
@section('title', 'Detail Bacaan Unit ' . $periode->edisi)
...
@include('partials.page-header', [
    'title'     => $periode->edisi . ' - Bacaan Unit',
    'subtitle'  => $subtitle,
    'back'      => route('import.pasif.bacaan'),
    'backLabel' => 'Kembali ke Daftar Bacaan Unit',
])
@include('partials.stat-cards', ['stats' => [
    ['Total Unit', $periode->pesanan->count()],
    ['Total Bacaan', number_format($totalBacaan), true],
]])
