...
<head>
    ...
    <title>Bacaan Unit - biMBA AIUEO Logistik</title>
...
<div class="flex h-screen">
    <div class="flex-1 p-8 overflow-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Bacaan Unit</h2>
                <p class="text-gray-500 mt-1">Data Bacaan Unit dari pemesanan majalah Pasif</p>
            </div>
                           ...
                           <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('import.pasif.bacaan.show', $periode->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center text-gray-400">
                                Belum ada data Bacaan Unit. Silakan import data Unit Pasif terlebih dahulu.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
