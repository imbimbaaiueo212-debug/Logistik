...
<head>
    ...
    <title>Rekap Total - biMBA AIUEO Logistik</title>
...
<div class="flex h-screen">
    <div class="flex-1 p-8 overflow-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Rekap Total</h2>
                <p class="text-gray-500 mt-1">Hasil import lengkap — Bacaan Unit + Qty Majalah</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ route('import.pasif.create') }}"
            ...
            <table class="w-full text-left">
                <thead class="bg-gray-100 text-gray-600 text-sm uppercase">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center">Total Bacaan</th>
                ...
                <tbody class="divide-y">
                    @forelse($periodes as $periode)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 font-semibold text-blue-700">{{ $periode->edisi }}</td>
                            <td class="px-6 py-4">{{ $periode->periode ?? ($periode->bulan . ' ' . $periode->tahun) }}</td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-center">{{ $periode->pesanan_count }}</td>
                            <td class="px-6 py-4 text-center font-medium text-emerald-700">
                                {{ number_format($periode->pesanan_sum_bacaan_unit ?? 0) }}
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('import.pasif.rekap.show', $periode->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center text-gray-400">
                                Belum ada data. Silakan import terlebih dahulu.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
