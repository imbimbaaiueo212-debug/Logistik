...
<head>
    ...
    <title>Rekap Aktual Manual Sertifikat - biMBA AIUEO</title>
...
<div class="max-w-screen-2xl mx-auto px-6 py-6">
    ...
    <div class="flex justify-between items-center mb-8 flex-wrap gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Rekap Aktual Manual Sertifikat</h1>
            <p class="text-gray-600">Data Realisasi Sertifikat yang sudah diproses</p>
        </div>
        ...
        <div class="bg-white shadow-lg border-2 border-gray-800 mb-8 rounded-xl overflow-hidden"
            ...
            <button type="button" onclick="toggleContent('{{ $collapseId }}')"
                ...
                <div class="flex-1 text-center px-6">
                    <div>
                        <span class="font-bold text-lg">Rekap Aktual Manual Sertifikat</span>
