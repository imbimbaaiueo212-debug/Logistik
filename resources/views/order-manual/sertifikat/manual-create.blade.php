...
<head>
    ...
    <title>Create Manual Sertifikat - biMBA AIUEO Logistik</title>
...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-lg font-semibold text-gray-800">Create Manual Sertifikat</h1>
    ...
    <form id="formManualSertifikat" action="{{ route('order-manual-sertifikat.manual.store') }}" method="POST">
        @csrf
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input type="text" class="field-input bg-gray-100 text-gray-500"
                                value="Otomatis (contoh: MS-{{ date('Ymd') }}-0001)" disabled>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input type="number" name="order_weight" value="{{ old('order_weight') }}"
                ...
                <tr class="item-row border-b border-gray-100">
                    ...
                    <td class="py-2 pr-2">
                        <input type="text" name="items[{{ $i }}][product_name]" required
                            class="field-input product-name" placeholder="Nama produk"
                            value="{{ $item['product_name'] ?? '' }}">
                    </td>
                    <td class="py-2 pr-2">
                        <input type="text" name="items[{{ $i }}][jenis]" class="field-input product-jenis"
                            placeholder="Jenis" value="{{ $item['jenis'] ?? '' }}">
                    </td>
                    <td class="py-2 pr-2">
                        <input type="text" name="items[{{ $i }}][kategori]" class="field-input product-kategori"
                            placeholder="Kategori" value="{{ $item['kategori'] ?? '' }}">
                    </td>
                    <td class="py-2 pr-2">
                        <input type="number" name="items[{{ $i }}][harga_jual]" step="0.01" min="0"
                            class="field-input product-harga" placeholder="0"
...
$(document).ready(function () {
    $('.sku-select').each(function () { initSkuSelect(this); });
