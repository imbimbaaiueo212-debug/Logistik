...
@section('title', 'Order Manual Sertifikat')
...
@section('content')
    ...
    @php
        ...
        $menu = [
            ['Manual Pemesanan Sertifikat', 'Input data pemesanan sertifikat secara manual, termasuk produk dan jumlah.', route('order-manual-sertifikat.manual'), 'edit'],
        ];
    @endphp

    {{-- ============ JUDUL ============ --}}
    <div class="min-w-0">
        <h1 class="text-2xl sm:text-[28px] leading-tight font-bold text-navy-950">Order Manual Sertifikat</h1>
        <p class="mt-1 text-sm text-navy-950/55">Kelola data pemesanan sertifikat secara manual</p>
    </div>
