...
@section('title', 'Picking List - Jakarta Aktif - biMBA AIUEO Logistik')
    ...
    <div class="bg-white rounded-3xl shadow p-6 mb-6">
        <form method="GET" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div class="flex items-end gap-3 pt-6 lg:col-span-2">
                <button type="submit" class="bg-blue-600 text-white px-6 py-2.5 rounded-xl hover:bg-blue-700 flex-1 inline-flex items-center justify-center gap-2">
